...
Invoke-RestMethod https://gist.githubusercontent.com/caseydaviscec/dbc1cd946f76dd9fedb2a3940105b797/raw/osdcloud.shh | Out-File -FilePath 'C:\Windows\Setup\scripts\autopilot.ps1' -Encoding ascii -Force
$OOBECMD = @'
@echo off
