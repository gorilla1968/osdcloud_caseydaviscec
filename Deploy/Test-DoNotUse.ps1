...
https://raw.githubusercontent.com/caseydaviscec/osdcloud/refs/heads/main/Teams-Webhook.ps1 | Out-File -FilePath 'C:\Windows\Setup\scripts\teams-webhook.ps1' -Encoding ascii -Force
$OOBECMD = @'
@echo off
